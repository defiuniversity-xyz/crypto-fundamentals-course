...
### Header Image
**Concept:** Business card with public address visible, contrasted with a vault containing private key that's never shown
**Style:** Share vs. protect contrast
**Dimensions:** 1200x630px

### Concept Infographic
**Title:** "The One-Way Relationship"
**Content:** Flowchart: Private Key → (one-way math) → Public Key → (one-way math) → Address. Show arrows only go forward.
**Style:** Directional flow with "No going back" symbols

### Analogy Illustration
**Concept:** Email address on business card vs. password locked in safe
**Style:** Everyday office scenario

### Audio Notes
- Email analogy is very relatable—use it throughout
- Show different address formats visually in supplementary materials
- Emphasize address verification for safety
- Duration target: 4 minutes

### Video Concept
- Animation of deriving address from private key (simplified)
- Attempt to reverse—show it fails
- Examples of different chain address formats
