...
```
Custodial    →    Hot Wallet    →    Hardware Wallet    →    Paper/Steel
Exchange         Mobile App          Ledger/Trezor          Metal Backup
...
![Summary](https://storage.googleapis.com/crypto-fundamentals-media/images/lesson_12/crypto-fundamentals_12_summary.png)
...
### Header Image
**Concept:** Spectrum showing pocket wallet → home safe → bank vault, mapped to hot wallet → hardware wallet → cold storage
**Style:** Clear progression, security scale
**Dimensions:** 1200x630px

### Concept Infographic
**Title:** "The Wallet Security Spectrum"
**Content:** Visual spectrum: Custodial (easy, less control) → Hot (convenient, moderate risk) → Hardware (secure, less convenient) → Paper/Metal (maximum security, least convenient)
**Style:** Sliding scale with icons for each type

### Analogy Illustration
**Concept:** Different secure storage options for valuables—match wallet types to familiar storage choices
**Style:** Security-focused comparison

### Audio Notes
- Use the physical storage analogy throughout
- Present each type's pros and cons fairly
- Emphasize "match security to value"
- Duration target: 4-5 minutes

### Video Concept
- Visual comparison of wallet types
- Show use cases for each
- Demonstrate hardware wallet in action
- Duration: 3 minutes
