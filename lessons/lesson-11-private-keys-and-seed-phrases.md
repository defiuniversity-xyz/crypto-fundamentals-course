...
### Header Image
**Concept:** Single golden master key floating above multiple locks (apartment, car, safe, storage) it controls—emphasizing one key controlling everything
**Style:** Important, valuable, singular focus
**Dimensions:** 1200x630px

### Concept Infographic
**Title:** "The Seed Phrase Hierarchy"
**Content:** Visual tree: Seed Phrase → Master Key → Multiple Private Keys → Addresses. Show how one seed controls everything.
**Style:** Hierarchical tree diagram

### Analogy Illustration
**Concept:** Master key for all locks—show the power and the risk
**Style:** Serious, security-focused

### Audio Notes
- Make the master key analogy visceral
- Repeat the "NEVER share" rules emphatically
- Tell a brief story of loss to make it real
- Duration target: 4-5 minutes

### Video Concept
- Animation showing seed phrase generating wallet
- Demonstrate the "what if lost" and "what if shared" scenarios
- Show proper storage methods
- Duration: 3 minutes
