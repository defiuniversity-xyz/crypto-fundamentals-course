...
![Summary](https://storage.googleapis.com/crypto-fundamentals-media/images/lesson_08/crypto-fundamentals_08_summary.png)
...
### Header Image
**Concept:** Three different highways/roads with different characteristics—interstate (secure, slow), state road (balanced), expressway (fast, newer)
**Style:** Aerial view of different road types
**Dimensions:** 1200x630px

### Concept Infographic
**Title:** "The Blockchain Trilemma"
**Content:** Triangle with Security, Decentralization, Scalability at corners. Show where Bitcoin, Ethereum, Solana fall within.
**Style:** Triangle diagram with positioning

### Analogy Illustration
**Concept:** Three highways with different properties labeled, vehicles choosing routes
**Style:** Traffic/route decision visual

### Audio Notes
- Use highway analogy throughout
- Present each blockchain fairly—pros AND cons
- Explain the trilemma simply
- Duration target: 4-5 minutes

### Video Concept
- Animated comparison of three blockchains processing transactions
- Visualize the trilemma trade-offs
- Show Layer 2 as enhancement
- Duration: 3 minutes
