...
![Summary](https://storage.googleapis.com/crypto-fundamentals-media/images/lesson_03/crypto-fundamentals_03_summary.png)
...
### Header Image
**Concept:** Two globes: one with walls, gates, and checkpoints between countries; one with open connections and light flowing freely
**Style:** Contrasting restricted vs. open global access
**Dimensions:** 1200x630px

### Concept Infographic
**Title:** "Permission Needed vs. Permissionless"
**Content:** Two columns showing steps to open bank account vs. steps to create crypto wallet. Show rejected applications on one side, instant access on other.
**Style:** Checklist/process comparison

### Analogy Illustration
**Concept:** Library with card desk and waiting line vs. open bookshelf anyone can access
**Style:** Welcoming community space imagery

### Audio Notes
- Start with library analogy to establish concept
- Use specific examples of who benefits from permissionless access
- Address the double-edged sword honestly
- Duration target: 4 minutes

### Video Concept
- Map animation showing traditional money moving (complex routes, checkpoints)
- Same map with crypto (direct lines, instant)
- Stories of people who benefit from permissionless access
