...
### Header Image
**Concept:** Giant shared document floating in cloud, with many people around the world looking at it and adding to it, but no one able to erase
**Style:** Collaborative, global, transparent visual
**Dimensions:** 1200x630px

### Concept Infographic
**Title:** "How Blocks Chain Together"
**Content:** Visual showing Block 1 → Block 2 → Block 3, with reference pointers highlighted. Show what happens if Block 2 is altered (chain breaks)
**Style:** Chain links with data references visible

### Analogy Illustration
**Concept:** Google Doc comparison—shared view, edit history, multiple collaborators
**Style:** Familiar interface with blockchain properties labeled

### Audio Notes
- Start with Google Doc analogy—very relatable
- Explain blocks and chains simply before technical details
- Emphasize the "thousands of witnesses" concept
- Duration target: 4-5 minutes

### Video Concept
- Animation of a shared document with people adding transactions
- Zoom in to show how blocks link together
- Attempt to edit old block—show cascade failure
