...
![Summary](https://storage.googleapis.com/crypto-fundamentals-media/images/lesson_04/crypto-fundamentals_04_summary.png)
...
### Header Image
**Concept:** Split clock/globe: one side showing bank "CLOSED" sign at night, other side showing 24/7 digital network active across all time zones
**Style:** Day/night contrast, activity vs. dormancy
**Dimensions:** 1200x630px

### Concept Infographic
**Title:** "When Can You Access Your Money?"
**Content:** 24-hour clock showing: Bank (small slice of hours), Stock Market (another slice), Crypto (full 24 hours highlighted)
**Style:** Clock/pie chart comparison

### Analogy Illustration
**Concept:** ATM with "Never Sleeps" sign, showing people using it at various unusual hours
**Style:** Night scene with welcoming light

### Audio Notes
- Start with the "ATM that never sleeps" concept
- Explain why traditional finance has hours
- Address the psychological angle of always-on trading
- Duration target: 4 minutes

### Video Concept
- Time-lapse of 24 hours: banks opening/closing while crypto network stays active
- Globe showing activity moving around time zones
- Both positive (access) and negative (no breaks) angles
