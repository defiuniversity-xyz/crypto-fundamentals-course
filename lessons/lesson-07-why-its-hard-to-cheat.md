...
### Header Image
**Concept:** Completed puzzle with one piece being lifted—showing how it disrupts the surrounding pieces and doesn't match the reference photo
**Style:** Detective/mystery feel, something "doesn't fit"
**Dimensions:** 1200x630px

### Concept Infographic
**Title:** "Why Changing History Fails"
**Content:** Chain of blocks with hashes shown. Demonstrate: change Block 5 → new hash → Block 6's reference breaks → cascade failure
**Style:** Domino effect visualization

### Analogy Illustration
**Concept:** Puzzle piece swap attempt being caught by crowd of photo-holders
**Style:** Public square scene with witnesses

### Audio Notes
- Make the puzzle analogy vivid and visual
- Explain hashes simply—don't go into math
- Be clear that security isn't absolute
- Duration target: 4-5 minutes

### Video Concept
- Animation of attempting to change a historical block
- Show hash mismatch cascading forward
- Visualize how the network rejects the fake chain
