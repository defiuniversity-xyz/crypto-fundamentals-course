...
**Core concept:** With cryptocurrency you can own and control, you actually hold the asset—like cash in your pocket—rather than an IOU from a company.
...
|---------------------|---------------------|
| Bank stores your money | You store your keys |
| Bank secures against theft | You secure against theft |
| Bank can recover your access | No recovery possible |
| Bank can freeze your account | No one can freeze it |
| Bank is liable if hacked | You're liable if hacked |
...
![Summary](https://storage.googleapis.com/crypto-fundamentals-media/images/lesson_02/crypto-fundamentals_02_summary.png)
...
### Header Image
**Concept:** Two people: one holding a physical coin/key, one holding a "promise note" IOU. Shows tangible vs. paper ownership.
**Style:** Clear visual metaphor for possession vs. promise
**Dimensions:** 1200x630px

### Concept Infographic
**Title:** "Custodial vs. Self-Custodial"
**Content:** Two columns comparing: Who holds assets, Who controls access, What if they fail, Recovery options
**Style:** Comparison table with icons

### Analogy Illustration
**Concept:** Cash in pocket (yours truly) vs. coat check ticket (claim on coat)
**Style:** Everyday scenario showing the difference

### Audio Notes
- Make the pocket vs. vault distinction clear
- Emphasize exchange risks with real examples (FTX)
- Present trade-offs neutrally—neither option is universally better
- Duration target: 4-5 minutes

### Video Concept
- Animation showing "your crypto" on exchange actually sitting in their vault
- What happens when things go wrong (exchange fails)
- Contrast with self-custody where only you have access
